...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  { step: 9, target: 'activate-transition-btn', titleKey: 'guide.step9.title', descKey: 'guide.step9.desc', position: 'right' },
  { step: 10, target: 'activate-btn', titleKey: 'guide.step10.title', descKey: 'guide.step10.desc', position: 'right' },
