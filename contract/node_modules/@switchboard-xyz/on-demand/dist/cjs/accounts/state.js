...
class State {
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const teeVerifyMode = (_b = params.teeVerifyMode) !== null && _b !== void 0 ? _b : state.teeVerifyMode;
            const ix = yield this.program.instruction.stateSetConfigs({
                ...
                addCostWl: (_f = params.addCostWl) !== null && _f !== void 0 ? _f : anchor_31_1.web3.PublicKey.default,
                rmCostWl: (_g = params.rmCostWl) !== null && _g !== void 0 ? _g : anchor_31_1.web3.PublicKey.default,
            }, {
                accounts: {
                    state: this.pubkey,
