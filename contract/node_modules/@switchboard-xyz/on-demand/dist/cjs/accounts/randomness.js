...
class Randomness {
    ...
    commitIx(queue, authority_, oracle_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (oracle_) {
                ...
                const solanaOracleInstance = yield solanaQueue.fetchOracleByLatestVersion();
                [oracle] = anchor_31_1.web3.PublicKey.findProgramAddressSync([
                ...
                const oracleInstance = yield queueAccount.fetchOracleByLatestVersion();
    ...
    revealIx(payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gateway = new gateway_js_1.Gateway(gatewayUrl);
