...
const instruction_utils_js_1 = require("../instruction-utils/instruction-utils.js");
const secp256k1_instruction_utils_js_1 = require("../instruction-utils/secp256k1-instruction-utils.js");
...
const common_legacy_1 = require("@switchboard-xyz/common-legacy");
...
class PullFeed {
    ...
    constructor(program, pubkey) {
        ...
        this.network = null; // Cache network detection
        this.gatewayUrl = '';
    ...
    preHeatLuts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const luts = yield (0, index_js_2.loadLookupTables)(lutOwners);
            return luts;
        });
    }
    static initTx(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = yield instruction_utils_js_1.InstructionUtils.asV0TxWithComputeIxs({
    ...
    static getPayer(program, payer) {
        ...
        throw new Error('No payer available. Either provide an explicit payer parameter or use a provider with a connected wallet.');
    }
    getPayer(payer) {
    ...
    loadJobs() {
        return __awaiter(this, arguments, void 0, function* (crossbarClient = common_1.CrossbarClient.default()) {
            ...
            if (this.network === null) {
                const isMainnet = yield (0, index_js_1.isMainnetConnection)(this.program.provider.connection);
            ...
            const legacyClient = new common_legacy_1.LegacyCrossbarClient(crossbarClient.crossbarUrl);
            this.jobs = yield legacyClient
    ...
    static fetchUpdateIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oracleResponses = report.oracle_responses.map(x => {
                ...
                const oraclePubkey = new anchor_31_1.web3.PublicKey(oraclePubkeyBytes);
     ...
     */
    static fetchUpdateManyIx(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const feeds = (() => {
            ...
            const secpInstruction = secp256k1_instruction_utils_js_1.Secp256k1InstructionUtils.buildSecp256k1Instruction(secpSignatures, (_d = params.signatureInstructionIdx) !== null && _d !== void 0 ? _d : 0);
            ...
            const accounts = {
                ...
                systemProgram: anchor_31_1.web3.SystemProgram.programId,
                rewardVault: spl.getAssociatedTokenAddressSync(constants_js_1.SOL_NATIVE_MINT, queue, false),
                tokenProgram: constants_js_1.SPL_TOKEN_PROGRAM_ID,
    ...
    static fetchUpdateManyLightIx(program_1, params_1) {
        return __awaiter(this, arguments, void 0, function* (program, params, debug = false) {
            ...
            const secpInstruction = secp256k1_instruction_utils_js_1.Secp256k1InstructionUtils.buildSecp256k1Instruction(secpSignatures, 0);
            // Prepare the instruction data for the `pullFeedSubmitResponseManySecp` instruction.
            const instructionData = {
                slot: new anchor_31_1.BN(response.slot),
                values: response.median_responses.map(({ value }) => new anchor_31_1.BN(value)),
