...
function getQueue(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const program = 'program' in params
            ? params.program
            : yield anchor_utils_js_1.AnchorUtils.loadProgramFromConnection(new anchor_31_1.web3.Connection(params.solanaRPCUrl, 'confirmed'));
...
function storeFeed(queue_1, jobs_1) {
    return __awaiter(this, arguments, void 0, function* (queue, jobs, crossbarUrl = common_1.CrossbarClient.default().crossbarUrl) {
        console.warn('[Switchboard] Warning: storeFeed() is deprecated. Use CrossbarClient.storeOracleFeed() instead.');
        const crossbar = crossbarUrl.endsWith('/')
            ? crossbarUrl.slice(0, -1)
            : crossbarUrl;
        const x = new common_legacy_1.LegacyCrossbarClient(crossbar);
