...
import { SPL_SYSVAR_INSTRUCTIONS_ID, SPL_SYSVAR_SLOT_HASHES_ID, } from '../constants.js';
...
export class SurgeUpdate {
    ...
    toQuoteIx(queuePubkey, payer, instructionIdx = 0) {
        ...
        const [oracleAccount, bump] = OracleQuote.getCanonicalPubkey(queuePubkey, feedHashes, QUOTE_PROGRAM_ID);
        const opcode = 0;
...
export class Surge extends EventEmitter {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.config.queue) {
                    ...
                    try {
                        const env = yield AnchorUtils.loadEnv();
    ...
    attemptSessionRequest(attempt, maxRetries, feedHints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios.post(requestUrl, requestBody, { headers });
            ...
            try {
                ...
                for (const feed of feeds) {
                    if ('symbol' in feed) {
                        ...
                        this.log(`✅ Validated: ${feed.symbol} ${feed.source ? `(${typeof feed.source === 'string' ? feed.source : Source.toString(feed.source)})` : ''}`);
                    }
                }
            }
            catch (error) {
