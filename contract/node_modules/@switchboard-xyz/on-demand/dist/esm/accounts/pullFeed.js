...
import { Big, CrossbarClient, CrossbarNetwork, FeedHash, NonEmptyArrayUtils, } from '@switchboard-xyz/common';
    ...
    loadJobs() {
        return __awaiter(this, arguments, void 0, function* (crossbarClient = CrossbarClient.default()) {
            ...
            if (this.network === null) {
                const isMainnet = yield isMainnetConnection(this.program.provider.connection);
    ...
    static fetchUpdateManyIx(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const accounts = {
                ...
                systemProgram: web3.SystemProgram.programId,
                rewardVault: spl.getAssociatedTokenAddressSync(SOL_NATIVE_MINT, queue, false),
                tokenProgram: SPL_TOKEN_PROGRAM_ID,
