...
export declare class SurgeUpdate {
    ...
    getLatencyMetrics(): {
        isHeartbeat: boolean;
        swInternalLatencyMs: number;
        oracleBroadcastToClientMs: number;
        emitLatencyMs: number;
        perFeedMetrics: Array<{
            symbol: string;
            source: string;
            feed_hash: string;
            sourceToOracleMs: number;
            emitLatencyMs: number;
        }>;
    };
    /**
     ...
     */
    toQuoteIx(queuePubkey: web3.PublicKey, payer: web3.PublicKey, instructionIdx?: number): web3.TransactionInstruction[];
    /**
     ...
     */
    getBroadcastTimestamp(): number | undefined;
    /**
     ...
     */
    getHeartbeatTimestamp(): number | undefined;
    /**
...
export declare class Surge extends EventEmitter {
     ...
     */
    connect(feedHints?: FeedSubscription[]): Promise<void>;
    /**
